...
def dictionary():
	...
	d[1] = {sentences2[i]: "https://en.wikipedia.org/wiki/Cetacea" for i in range(0, len(sentences2))}
	...
	d[2] = {sentences3[i]: "https://en.wikipedia.org/wiki/Killer_whale" for i in range(0, len(sentences3))}
	...
	d[3] = {sentences4[i]: "https://en.wikipedia.org/wiki/Humpback_whale" for i in range(0, len(sentences4))}
	...
	d[4] = {sentences5[i]: "https://en.wikipedia.org/wiki/Baleen_whale" for i in range(0, len(sentences5))}
	...
	d[5] = {sentences6[i]: "https://en.wikipedia.org/wiki/Pilot_whale" for i in range(0, len(sentences6))}
	...
	d[6] = {sentences7[i]: "https://en.wikipedia.org/wiki/Sperm_whale" for i in range(0, len(sentences7))}
	...
	d[7] = {sentences8[i]: "https://en.wikipedia.org/wiki/Sei_whale" for i in range(0, len(sentences8))}
	...
	d[8] = {sentences9[i]: "https://en.wikipedia.org/wiki/Blue_whale" for i in range(0, len(sentences9))}
	...
	d[9] = {sentences10[i]: "https://en.wikipedia.org/wiki/Captive_killer_whales" for i in range(0, len(sentences10))}
	...
	d[10] = {sentences13[i]: "https://en.wikipedia.org/wiki/Evolution_of_cetaceans" for i in range(0, len(sentences13))}
	...
	d[11] = {sentences16[i]: "https://en.wikipedia.org/wiki/Whale_shark" for i in range(0, len(sentences16))}

	text17 = ''.join(open("whale_data/whale_doc17", "r").readlines())
	sentences17 = re.split(r"\.\s*", text17)

	d[12] = {sentences17[i]: "https://en.wikipedia.org/wiki/Beluga_whale" for i in range(0, len(sentences17))}

	text18 = ''.join(open("whale_data/whale_doc18", "r").readlines())
	sentences18 = re.split(r"\.\s*", text18)

	d[13] = {sentences18[i]: "http://us.whales.org/whales-and-dolphins/facts-about-whales" for i in range(0, len(sentences18))}

	text19 = ''.join(open("whale_data/whale_doc19", "r").readlines())
	sentences19 = re.split(r"\.\s*", text19)

	d[14] = {sentences19[i]: "https://www.worldwildlife.org/species/whale" for i in range(0, len(sentences19))}

	text20 = ''.join(open("whale_data/whale_doc20", "r").readlines())
	sentences20 = re.split(r"\.\s*", text20)

	d[15] = {sentences20[i]: "http://www.defenders.org/whales/basic-facts" for i in range(0, len(sentences20))}
